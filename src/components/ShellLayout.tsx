    ...
    return (
        <>
            <Header aria-label="D.A.G.R. Enterprise OS">
                ...
                >
                    <span className="customer-badge">Phoenix Ebra</span>
                </HeaderName>
                <HeaderNavigation aria-label="Workspace navigation">
                    ...
                    >
                        ...
                        <HeaderMenuItem
                            isCurrentPage={location.pathname.includes('/data/shipping')}
                            onClick={(e) => { e.preventDefault(); navigate('/workspace/data/shipping'); }}
                        >
                            Shipments · ShipTrack
                        </HeaderMenuItem>
                        <HeaderMenuItem
                            isCurrentPage={location.pathname.includes('/data/cultivars')}
                            onClick={(e) => { e.preventDefault(); navigate('/workspace/data/cultivars'); }}
                        >
                            Cultivars · LIMS
                        </HeaderMenuItem>
                        <HeaderMenuItem
                            isCurrentPage={location.pathname.includes('/data/chambers')}
                            onClick={(e) => { e.preventDefault(); navigate('/workspace/data/chambers'); }}
                        >
                            Chambers · ChamberOS
                        </HeaderMenuItem>
                    </HeaderMenu>
