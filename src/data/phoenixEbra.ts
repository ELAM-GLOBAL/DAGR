...
export const SITES: Site[] = [
    {
        ...
        chambers: 12,
        monthlyVolume: 48000,
        cultivars: ['Orchid', 'Grape (3n)', 'Pistachio'],
        tatDays: 12,
        contamination: 0.4,
        margin: 84.1,
        note: 'Anchor site. Genetic verification + 3n triploid line live here. Caribbean export gateway.',
    },
    {
        id: 'tn',
        name: 'Knoxville',
    ...
    },
    {
        ...
        lng: -96.80,
        status: 'live',
        commissionedAt: '2025-04',
        chambers: 4,
        monthlyVolume: 12600,
        cultivars: ['Agave', 'Hemp'],
        tatDays: 14,
        contamination: 0.6,
        margin: 81.5,
        note: 'Southwest hub. Agave + low-THC hemp regional production for TX/OK/NM/AZ.',
    },
];
