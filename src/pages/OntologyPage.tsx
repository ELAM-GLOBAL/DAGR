...
import { SOURCES, ENTITIES, OUTPUTS, OntologyEntity } from '../data/raghavTrading';
            ...
            <div style={{
                ...
                <div>
                    ...
                    <h2 style={{ margin: 0, fontWeight: 300, fontSize: '1.75rem' }}>
                        Trading firm · Data Model
                    </h2>
                    <p style={{ margin: '0.25rem 0 0 0', fontSize: '0.875rem', color: 'var(--cds-text-secondary)' }}>
                        Broker sources → Object types → Derived outputs. Hover any node to trace its joins.
                    </p>
                </div>
            ...
            <div style={{ flex: 1, display: 'flex', overflow: 'hidden' }}>
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <ColumnHeader x={COL_WIDTH + COL_GAP} label="OBJECT TYPES" sub="The trading firm ontology" />
